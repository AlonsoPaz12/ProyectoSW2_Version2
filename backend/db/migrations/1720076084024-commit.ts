...
export class Commit1720076084024 implements MigrationInterface {
    name = 'Commit1720076084024'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "imagen_medica" ADD CONSTRAINT "FK_4424d0f65c0fbd49ac1e95740a1" FOREIGN KEY ("ordenId") REFERENCES "orden_medica"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "imagen_medica" DROP CONSTRAINT "FK_4424d0f65c0fbd49ac1e95740a1"`);

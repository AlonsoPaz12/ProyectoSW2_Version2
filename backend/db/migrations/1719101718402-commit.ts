...
export class Commit1719101718402 implements MigrationInterface {
    name = 'Commit1719101718402'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "vacuna" ("id" SERIAL NOT NULL, "nombre" character varying NOT NULL, CONSTRAINT "PK_2074f68e883250fb57002dbe685" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "hora_disponible" ("id" SERIAL NOT NULL, "fecha" date NOT NULL, "horaInicio" TIME NOT NULL, "horaFin" TIME NOT NULL, "medicoId" integer, CONSTRAINT "PK_2c01fdb58cd9b7e778ee676b9c5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "componente_resultado" ("id" SERIAL NOT NULL, "nombre" character varying NOT NULL, "resultado" character varying NOT NULL, "unidad" character varying NOT NULL, "resultadoLabId" integer, CONSTRAINT "PK_a096d6626bf1c3dc1c90a81d1b9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "resultado_lab" ("id" SERIAL NOT NULL, "imageurl" character varying NOT NULL, "numeroDocumento" character varying NOT NULL, "nombres" character varying NOT NULL, "apePaterno" character varying NOT NULL, "apeMaterno" character varying NOT NULL, "fechaNacimiento" TIMESTAMP NOT NULL, "numCelular" character varying NOT NULL, "correoElectronico" character varying NOT NULL, "contrasena" character varying NOT NULL, "repContrasena" character varying NOT NULL, "genero" character varying NOT NULL, "motivoPrueba" character varying NOT NULL, "fecha" TIMESTAMP NOT NULL, "Resultado" character varying NOT NULL, "unidades" character varying NOT NULL, "rangoNormal" character varying NOT NULL, "orden_medica_id" integer, CONSTRAINT "REL_383bc394486c7547ae52da8ddd" UNIQUE ("orden_medica_id"), CONSTRAINT "PK_bcb902819fd116bb7fc7baf6f4e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "medico_vacunas_vacuna" ("medicoId" integer NOT NULL, "vacunaId" integer NOT NULL, CONSTRAINT "PK_e71d4f508a06895b4e5455318e7" PRIMARY KEY ("medicoId", "vacunaId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_705142fe02bc1f3dc0d5075f63" ON "medico_vacunas_vacuna" ("medicoId") `);
        await queryRunner.query(`CREATE INDEX "IDX_0fd966eca5dead5b23d7319ba9" ON "medico_vacunas_vacuna" ("vacunaId") `);
        ...
        await queryRunner.query(`ALTER TABLE "medico_vacunas_vacuna" ADD CONSTRAINT "FK_705142fe02bc1f3dc0d5075f63d" FOREIGN KEY ("medicoId") REFERENCES "medico"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "medico_vacunas_vacuna" ADD CONSTRAINT "FK_0fd966eca5dead5b23d7319ba9b" FOREIGN KEY ("vacunaId") REFERENCES "vacuna"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "medico_vacunas_vacuna" DROP CONSTRAINT "FK_0fd966eca5dead5b23d7319ba9b"`);
        await queryRunner.query(`ALTER TABLE "medico_vacunas_vacuna" DROP CONSTRAINT "FK_705142fe02bc1f3dc0d5075f63d"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_0fd966eca5dead5b23d7319ba9"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_705142fe02bc1f3dc0d5075f63"`);
        await queryRunner.query(`DROP TABLE "medico_vacunas_vacuna"`);

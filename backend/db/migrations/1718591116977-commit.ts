...
export class Commit1718591116977 implements MigrationInterface {
    name = 'Commit1718591116977'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "resultado_lab" ("id" SERIAL NOT NULL, "tipo" character varying NOT NULL, "observacion" character varying NOT NULL, "nombrePaciente" character varying NOT NULL, "orden_medica_id" integer, CONSTRAINT "REL_383bc394486c7547ae52da8ddd" UNIQUE ("orden_medica_id"), CONSTRAINT "PK_bcb902819fd116bb7fc7baf6f4e" PRIMARY KEY ("id"))`);

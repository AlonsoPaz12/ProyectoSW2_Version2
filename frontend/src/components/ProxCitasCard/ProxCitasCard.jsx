        ...
        <div>
          <div style={{ display: 'flex' }}>
            <div style={{ marginLeft: '12px' }}>
              <h6 style={{ margin: '0' }}>{doctor}</h6>
              <p style={{ fontSize: '10px' }}>Especialidad</p>
            </div>
            <FaHeart
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <p style={{ margin: '0', marginTop: '1px', fontSize: '12px', marginLeft: '4px' }}>{fecha}</p>
            <FaRegClock size={'20'} color='#00916E' style={{ marginLeft: '80px' }} />
            <p style={{ margin: '0', marginTop: '1px', fontSize: '12px', marginLeft: '4px' }}>{hora}</p>
          </div>
        </div>
      </div>
